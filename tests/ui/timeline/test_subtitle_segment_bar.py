...
#     mocker.patch("src.managers.video_manager.VideoManager.video_duration", return_value=10.0)
#     mocker.patch("src.managers.transcription_manager.TranscriptionManager._load_model")
#     mocker.patch("src.ui.media_player.MediaPlayer._initialize_mpv", return_value=True)
#     mocker.patch("src.ui.subtitle_editor_app.SubtitleEditorApp._render_subtitles_on_player")
#
